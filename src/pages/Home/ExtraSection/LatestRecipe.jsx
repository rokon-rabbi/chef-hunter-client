      ...
      <div className="relative  md:p-36 p-14 grid md:grid-cols-3  grid-cols-1 gap-10 ">
        <div className=" bg-white  h-75  rounded overflow-hidden shadow-xl ">
          <img
            ...
            src="https://hips.hearstapps.com/hmg-prod/images/190416-chicken-burger-082-1556204252.jpg?crop=0.670xw:1.00xh;0.252xw,0&resize=360:*"
            alt="chicken"
          />
          <div className="px-6 grid justify-center py-4">
            ...
            <div className="d-flex">
              ...
              <span className="inline text-xs">
                by{" "}
                <span className="font-bold text-zinc-900">Sanjeev Kapoor</span>
              </span>
            </div>
          </div>
        ...
        <div className=" h-75  bg-white rounded overflow-hidden shadow-xl  ">
          <img
            className=" rounded-3xl shadow-sm p-5  md:h-80 h-64 w-full"
            src="https://hips.hearstapps.com/hmg-prod/images/grilled-chicken-horizontal-1532030541.jpg?crop=0.615xw:0.923xh;0.176xw,0.0457xh&resize=360:*"
            alt="chicken"
          />
          <div className="px-6 grid justify-center py-4">
            ...
            <div className="d-flex">
              ...
              />
              <span className="inline text-xs">
                by <span className="font-bold text-zinc-900">Vikas Khanna</span>
              </span>
            </div>
          </div>
          <div className="px-6 pt-4 pb-2 d-flex  text-center  space-x-5"></div>
        ...
        <div className=" h-75  bg-white  rounded overflow-hidden shadow-xl  ">
          <img
            className=" rounded-3xl shadow-sm p-5  md:h-80 h-64 w-full"
            src="https://hips.hearstapps.com/del.h-cdn.co/assets/17/26/2048x2048/square-1498598755-teriyaki-chicken.jpg?resize=360:*"
            alt="chicken"
          />
          ...
          <div className="px-6 grid justify-center py-4">
            ...
            <div className="d-flex">
              ...
              <span className="inline text-xs">
                by{" "}
                <span className="font-bold text-zinc-900">Saransh Goila</span>
              </span>
            </div>
          </div>
